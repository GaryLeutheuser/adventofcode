...
void TurnOn(int [][1000], vector<int>, vector<int>);
void TurnOff(int [][1000], vector<int>, vector<int>);
void Toggle(int [][1000], vector<int>, vector<int>);
int CountLights(int [][1000]);
...
void TurnOn(int grid[][1000], vector<int> start_point, vector<int> end_point) {
  int i,j;
...
void TurnOff(int grid[][1000], vector<int> start_point, vector<int> end_point) {
  int i,j;
  for (i = start_point[0]; i <= end_point[0]; ++i) {
    for (j = start_point[1]; j <= end_point[1]; ++j) {
      if (grid[i][j] > 0) {
...
void Toggle(int grid[][1000], vector<int> start_point, vector<int> end_point) {
 int i,j;
  for (i = start_point[0]; i <= end_point[0]; ++i) {
    for (j = start_point[1]; j <= end_point[1]; ++j) {
      grid[i][j] += 2;
